...
- [Example](www/localhost/) web applications, including [PHP](www/localhost/php.php), [Perl](www/localhost/perl.pl), [R](www/localhost/rscript.r), [D lang](www/localhost/keepalive.d), [brainfuck](www/localhost/test.bf) and [Ada](www/localhost/test.ada).
