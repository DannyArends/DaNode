...
class CGI : Payload {
  ...
  public:
    ...
    // TODO: Parse the returned data and see if there is a mime-type to parse
    final @property string mimetype() const { return "text/html"; }
    ...
    @property final string fullHeader() const { return(getheader(external.output(0))); }
